/**
 * Constants we can use for our game
 */
public class Constants {
    public final static String UNKNOWN_PLAYER_NAME = "Choose a player, and start " +
            "again.\nThe players: " +
            "[human, clever, whatever, genius]";

    public final static String UNKNOWN_RENDERER_NAME = "Choose a renderer, and start " +
            "again. \nPlease choose " +
